const providers = [
  ...
  
  {
    ...
    whatsappNumber: "",
    products: [
      { id: "Abrillantador10L", name: "Abrillantador 10L", unit: "garrafa" },
      { id: "BayetaMicro", name: "Bayeta microfibra", unit: "paquete" },
      { id: "BayetaPunto", name: "Bayeta punto", unit: "rollo" },
      { id: "BobinaSecaManos", name: "Bobina seca manos", unit: "fardo" },
      { id: "bolsaBasura85x115", name: "Bolsa de basura 85x115", unit: "caja" },
      { id: "DesengrasantePlancha", name: "Desengrasante plancha", unit: "garrafa" },
      { id: "LavavajillasMaquina", name: "Lavavajillas máquina", unit: "garrafa" },
      { id: "Nanas", name: "Nanas", unit: "paquete" },
      { id: "Film", name: "Film", unit: "rollos" },
      { id: "FregonaAlgodon", name: "Fregona de algodón", unit: "unidad" },
      { id: "Nacar", name: "Gel de manos nacar", unit: "garrafa" },
      { id: "GuanteNegroL", name: "Guante negro L", unit: "caja" },
      { id: "GuanteNegroM", name: "Guante negro M", unit: "caja" },
      { id: "GuanteNegroS", name: "Guante negro S", unit: "caja" },
      { id: "PañoCocina", name: "Paño de cocina", unit: "Paquete" },
      { id: "LimpiaCristales", name: "Limpia cristales", unit: "garrafa" },
      { id: "LavavajillaMaquina", name: "Lavavajillas máquina 20L", unit: "garrafa" },
      { id: "LavavajillaManual", name: "Lavavajillas manual", unit: "garrafa" },
      { id: "Oceanico", name: "Fregasuelos oceanico", unit: "garrafa" },
      { id: "PiedraPomez", name: "Piedra pomez", unit: "caja" },
      { id: "PapelAluminio", name: "Papel aluminio industrial", unit: "rollo" },
      { id: "PapelHigienicoIndustrial", name: "Papel higienico industrial", unit: "fardo" },
      { id: "Salvaunas", name: "Salvauñas", unit: "paquete" },
      { id: "Servilleta20x20", name: "Servilleta 20x20", unit: "caja" },
      { id: "Servilleta1/8", name: "Servilleta 1/8", unit: "caja" },
      { id: "bayetas", name: "Bayetas", unit: "paquete" },
      { id: "Spring", name: "Spring", unit: "caja" },
      { id: "ToallitasZ", name: "Toallita Z", unit: "caja" },
